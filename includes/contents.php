...
?>
                        ...
                        function showServerStatistics() {
                                ...
                                $context = stream_context_create(array(
                                    'http' => array('header' => "Authorization: Basic " . base64_encode($authInfo["login"] . ":" . $authInfo["password"]))
                                        ));
                            ...
                            <div class="row">
                                ...
                                <div class="card white" style="overflow-y: scroll">
                                    <div class="card-content grey-text text-darken-3">
                                      <p>
                                        <?php
                                        $search  = array('<h1>', '</h1>', '<h2>', '</h2>', '<table summary="status" class="status">');
                                        $replace = array('<h4>', '</h4>', '<h4>', '</h4>', '<table class="striped">');
                        ...
                        function showConfig($configFile) {
                            ...
                            <script type='text/javascript'>
                                ...
                                <?php
                                    if ($_GET["page"] == ContentGenerator::PAGE_4) { ?>
                            <div class="row">
                                <div class="col s12 m12 l8 offset-l2">
                                    <div class="card white">
                                        <div class="card-content grey-text text-darken-3">
...
<label style="padding-bottom:4px;" for="config-file-content"><?= basename($configFile); ?></label>
									        </div>
												<script type='text/javascript'>
                                  ...
                                  <div class="card white">
                                    <div class="card-content grey-text text-darken-3">
                                      <span class="card-title">KSWEB Settings</span>
                                        <br>
                                      <p>
                                        <input type="checkbox" class="filled-in" id="enable_root_func" disabled <?php if ($settings["enable_root_func"] == 'true')
                                                    echo "checked"; ?>>
                                        <label for="enable_root_func">Enable root functions</label>
                                        </p>
                                        <br>
                                        <p>
                                        <input type="checkbox" class="filled-in checkbox-blue" id="is_start_min" <?php if ($settings["is_start_min"] == 'true')
                                                    echo "checked"; ?>>
                                        <label class="label-text" for="is_start_min">Start minimized</label>
                                        </p>
                                        <br>
                                        <p>
                                        <input type="checkbox" class="filled-in checkbox-blue" id="auto_start" <?php if ($settings["auto_start"] == 'true')
                                                    echo "checked"; ?>>
                                        <label class="label-text" for="auto_start">Start KSWEB on system start</label>
                                        </p>
                                        <br>
                                        <p>
                                        <input type="checkbox" class="filled-in checkbox-blue" id="move_inis" <?php if ($settings["move_inis"] == 'true')
                                                    echo "checked"; ?>>
                                        <label class="label-text" for="move_inis">Use external ini files</label>
                                        </p>
                                        <br>
                                        <p>
                                        <input type="checkbox" class="filled-in checkbox-blue" id="wifiLock" <?php if ($settings["wifiLock"] == 'true')
                                                    echo "checked"; ?>>
